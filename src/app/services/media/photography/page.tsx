          ...
          <div className="relative mx-auto flex min-h-[40vh] max-w-7xl items-center px-6 py-16 sm:px-8 lg:px-12">
            ...
            >
              ...
              <h1 className="text-5xl font-bold leading-tight sm:text-6xl lg:text-7xl">
                <span className="text-[#FF6B35]">Photography</span>
              </h1>
            </motion.div>
          </div>
        </section>
          ...
          <div className="mx-auto max-w-4xl">
            ...
            >
              <div className="rounded-3xl border border-white/10 bg-white/5 p-8 md:p-12">
                <h2 className="text-2xl font-bold mb-6 text-[#FF6B35]">Professional Photography</h2>
                <p className="text-white/70 leading-relaxed mb-8">
                  Professional photography services for all occasions. We capture your special 
                  moments with precision and creativity.
                </p>

                <h2 className="text-2xl font-bold mb-6 text-[#FF6B35]">What's Included</h2>
                <ul className="text-white/70 leading-relaxed mb-8 space-y-3">
                  ...
                  <li>• Online gallery for viewing</li>
